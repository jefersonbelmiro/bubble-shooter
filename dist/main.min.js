...
c==F&&J(),F=c}return+f.slice(b,F)}if(d&&J(),"true"==f.slice(F,F+4))return F+=4,!0;if("false"==f.slice(F,F+5))return F+=5,!1;if("null"==f.slice(F,F+4))return F+=4,null;J()}return"$"},L=function(a){var b,c;if("$"==a&&J(),"string"==typeof a){if("@"==(t?a.charAt(0):a[0]))return a.slice(1);if("["==a){for(b=[];a=K(),"]"!=a;c||(c=!0))c&&(","==a?(a=K(),"]"==a&&J()):J()),","==a&&J(),b.push(L(a));return b}if("{"==a){for(b={};a=K(),"}"!=a;c||(c=!0))c&&(","==a?(a=K(),"}"==a&&J()):J()),(","==a||"string"!=typeof a||"@"!=(t?a.charAt(0):a[0])||":"!=K())&&J(),b[a.slice(1)]=L(K());return b}J()}return a},M=function(a,b,c){var d=N(a,b,c);d===g?delete a[b]:a[b]=d},N=function(a,b,c){var d,e=a[b];if("object"==typeof e&&e)if(h.call(e)==r)for(d=e.length;d--;)M(e,d,c);else f(e,function(a){M(e,a,c)});return c.call(a,b,e)};k.parse=function(a,b){var c,d;return F=0,G=""+a,c=L(K()),"$"!=K()&&J(),F=G=null,b&&h.call(b)==n?N((d={},d[""]=c,d),"",b):c}}}i&&a(function(){return k})}(this)},{}],48:[function(a,b,c){function d(a,b){var c=[];b=b||0;for(var d=b||0;d<a.length;d++)c[d-b]=a[d];return c}b.exports=d},{}]},{},[1])(1)});;!function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);var j=new Error("Cannot find module '"+g+"'");throw j.code="MODULE_NOT_FOUND",j}var k=c[g]={exports:{}};b[g][0].call(k.exports,function(a){var c=b[g][1][a];return e(c?c:a)},k,k.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(a,b,c){function d(a){this.player=a,this.service=new f("ai"),this.state="bootstrap",this.service.execute("bootstrap",[this.player.getMetaData()],this.tick,this)}var e=a("./bubble-shooter.js"),f=a("./background.js"),g=(a("./ui.js"),a("./bubble.js"));d.prototype.stop=function(){return this.state="stop",clearTimeout(this.timer)},d.prototype.tick=function(){clearTimeout(this.timer),"stop"!=this.state&&(this.timer=setTimeout(this.update.bind(this),1500))},d.prototype.update=function(){return"updating"!=this.state&&this.player.shooter.bubble?(this.state="updating",void this.fire(function(){this.updateGrid(function(){"stop"!=this.state&&(this.state="updated"),this.tick()})})):this.tick()},d.prototype.updateGrid=function(a){this.service.execute("updateGrid",[this.player.board.getGridMetaData()],a,this)},d.prototype.fire=function(a){var b=function(b){function c(){this.player.fire(a.bind(this),b.trajectory),this.player.shooter.load(g.getRandomSprite()),this.player.shooter.reload()}return this.player.shooter.rotation=b.rotation,c.call(this)};this.service.execute("findBestAgle",[this.player.shooter.bubble.tag],b,this)},d.prototype.randomMove=function(){var a=33,b=Math.abs(this.player.shooter.angle),b=Math.abs(180),c=Math.max(95,b-a),d=Math.min(265,b+a),f={angle:Utils.getRandomInt(c,d)};f.rotation=Utils.degreesToRadians(f.angle);var g=e.game.add.tween(this.player.shooter);g.to({rotation:f.rotation},1e3),g.onComplete.add(function(){this.randomMove()},this),g.start()},b.exports=d},{"./background.js":2,"./bubble-shooter.js":6,"./bubble.js":7,"./ui.js":17}],2:[function(a,b,c){function d(a){this.queue={},Worker?this.worker=new Worker("src/js/service."+a+".js"):alert("Error: Worker not suported!");var b=this;this.worker.addEventListener("message",function(a){var c=a.data,d=b.queue[c.id];b.queue[c.id]&&(b.queue[c.id].done.apply(d.context,c.args),delete b.queue[c.id])})}var e=a("./utils.js");d.prototype.execute=function(a,b,c,d){var f=e.generateUUID();c&&(this.queue[f]={done:c,context:d||null}),this.worker.postMessage({id:f,command:a,args:b})},b.exports=d},{"./utils.js":18}],3:[function(a,b,c){var d=a("./bubble-shooter.js"),e=a("./ui.js"),f=a("./bubble.js"),g=a("./utils.js"),h=function(a){this.player=a,this.side=a.side,this.x=0,this.y=0,this.grid=[],this.maxRows=0,this.maxCols=0};h.prototype={setGrid:function(a){this.grid=a,this.maxRows=this.grid.length,this.maxCols=this.grid[0].length},getGrid:function(){return this.grid},createGrid:function(a,b){this.maxRows=a,this.maxCols=b;for(var c=[],d=0;d<this.maxRows;d++){c[d]=[];for(var e=d%2===0,g=0;g<this.maxCols;g++)!e&&g>=this.maxCols-1||(c[d][g]=f.getRandomSprite())}return c},create:function(){var a=0;if(this.height=e.board.height-a,this.width=e.bubble.size*this.maxCols,d.game.width>this.width&&(this.x=(d.game.width-this.width)/2),this.side==d.PLAYER_SIDE_TOP){this.y=0;var b=d.entities.create(this.x,this.player.shooter.y+this.player.shooter.height/2,g.createRect(e.board.width,e.board.separatorHeight,"red"))}if(this.side==d.PLAYER_SIDE_BOTTOM){this.y=this.height+a,this.player.shooter.y=this.y+this.height-this.player.shooter.y,this.player.shooter.hand.y=this.player.shooter.y;var b=d.entities.create(this.x,this.player.shooter.y-this.player.shooter.height/2,g.createRect(e.board.width,e.board.separatorHeight,"red"))}this.player.shooter.bringToTop(),b.alpha=.5;var c=this.grid.slice(0);this.grid=[];for(var h=0,i=c.length;i>h;h++){this.grid[h]=[];for(var j=0,k=c[h].length;k>j;j++){var l=c[h][j],m=f.create(this.player,h,j,l);m.fixPositionByGrid(),this.grid[h][j]=m}}},addBubble:function(a){this.grid[a.row]||(this.grid[a.row]=[]),this.grid[a.row][a.col]&&console.error("addBubble rewrite grid",a.row,a.col),this.grid[a.row][a.col]=a},removeBubble:function(a,b){if(delete this.grid[a.row][a.col],!b)return a.kill();if("remove"==b){var c=d.game.add.tween(a.scale);c.to({x:0,y:0},200)}if("pop"==b){var c=d.game.add.tween(a);this.side==d.PLAYER_SIDE_TOP?(c.to({x:a.x,y:a.y-2*a.radius},100),c.to({x:a.x+a.radius,y:this.height},200)):(c.to({x:a.x,y:a.y-2*a.radius},100),c.to({x:a.x+a.radius,y:d.game.height},200))}c.onComplete.add(function(){a.kill()}),c.start()},getBubbleAt:function(a,b){return this.grid[a]&&this.grid[a][b]?this.grid[a][b]:!1},getBubblesAround:function(a,b){for(var c=[],d=a%2===0,e=a-1;a+1>=e;e++)for(var f=b-1;b+1>=f;f++)if((f!=b||e!=a)&&(d||e==a||f!==b-1)&&(!d||e==a||f!==b+1)){var g=this.getBubbleAt(e,f);g&&c.push(g)}return c},getGroup:function(a,b,c){var b=b||{},d=a.row,e=a.col;if(b[d]||(b[d]={}),b.list||(b.list=[]),b[d][e])return b;b[d][e]=a,b.list.push(a);for(var f=this.getBubblesAround(d,e),g=0;g<f.length;g++){var h=f[g];(h.tag==a.tag||c)&&(b=this.getGroup(h,b,c))}return b},findOrphans:function(){for(var a=[],b=[],c=0;c<this.grid.length;c++)a[c]=[];for(var d=0;d<this.grid[0].length;d++){var e=this.getBubbleAt(0,d);if(e&&!a[0][d]){var f=this.getGroup(e,{},!0);f.list.forEach(function(b){a[b.row][b.col]=!0})}}for(var c=0;c<this.grid.length;c++)for(var d=0;d<this.grid[c].length;d++){var e=this.getBubbleAt(c,d);e&&!a[c][d]&&b.push(e)}return b},checkMatches:function(a){var b=this.getGroup(a),c=this;return b.list.length<3?!1:void b.list.forEach(function(a){c.removeBubble(a,"remove")})},checkOrphans:function(){var a=this;this.findOrphans().forEach(function(b){a.removeBubble(b,"pop")})},getRemaining:function(){for(var a=[],b=0;b<this.grid.length;b++)for(var c=0;c<this.grid[b].length;c++){var d=this.getBubbleAt(b,c);d&&a.push(d)}return a},getNextBubbleTag:function(a){var b=[],a=a||this.getRemaining();return a.forEach(function(a){-1===b.indexOf(a.tag)&&b.push(a.tag)}),b.length<=2?b[g.getRandomInt(0,b.length-1)]:void f.getRandomSprite()},getGridMetaData:function(){for(var a=[],b=0;b<this.grid.length;b++){a[b]=[];for(var c=0;c<this.grid[b].length;c++){var d=this.getBubbleAt(b,c);a[b][c]=d?d.getMetaData():d}}return a},getMetaData:function(){return{x:this.x,y:this.y,width:this.width,height:this.height,side:this.side,grid:this.getGridMetaData()}}},b.exports=h},{"./bubble-shooter.js":6,"./bubble.js":7,"./ui.js":17,"./utils.js":18}],4:[function(a,b,c){var d=a("./ui.js"),e=function(a){this.game=a};e.prototype={preload:function(){this.stage.backgroundColor=d.background,this.load.image("loading-bg","src/img/loading-bg.png"),this.load.image("preload-bar","src/img/preload-bar.png"),this.load.image("preload-background","src/img/preload-backgorund.png")},create:function(){this.input.maxPointers=1,this.scale.scaleMode=Phaser.ScaleManager.SHOW_ALL,this.scale.pageAlignHorizontally=!0,this.scale.pageAlignVertically=!0,this.scale.updateLayout(),this.state.start("preloader")}},b.exports=e},{"./ui.js":17}],5:[function(a,b,c){var d=a("./bubble-shooter.js"),e=a("./ui.js"),f=a("./boot.js"),g=a("./preloader.js"),h=a("./menu.js"),i=a("./room.js"),j=a("./room-create.js"),k=a("./game.js"),l=d.game=new Phaser.Game(e.width,e.height,Phaser.AUTO);l.state.add("boot",f),l.state.add("preloader",g),l.state.add("menu",h),l.state.add("room",i),l.state.add("room-create",j),l.state.add("game",k),l.state.start("boot")},{"./boot.js":4,"./bubble-shooter.js":6,"./game.js":9,"./menu.js":10,"./preloader.js":12,"./room-create.js":13,"./room.js":14,"./ui.js":17}],6:[function(a,b,c){b.exports={debug:!1,BUBBLE_STATE_ON_BOARD:1,BUBBLE_STATE_FIRING:3,BUBBLE_STATE_POPPING:4,PLAYER_SIDE_TOP:"top",PLAYER_SIDE_BOTTOM:"bottom",MODES:{MULTIPLAYER:"multiplayer",SINGLEPLAYER:"singleplayer"}}},{}],7:[function(a,b,c){function d(a,b,c,f){Phaser.Sprite.call(this,e.game,0,0,"sprites",f||d.getRandomSprite()),e.entities.bubbles.add(this),this.player=a,this.tag=f||this.frameName,this.scale.setTo(g.bubble.scale),this.anchor.setTo(.5),this.row=b,this.col=c,this.radius=g.bubble.radius}var e=a("./bubble-shooter.js"),f=a("./utils.js"),g=a("./ui.js");self.Phaser&&(d.prototype=Object.create(Phaser.Sprite.prototype),d.prototype.constructor=d),d.prototype.getGridByPosition=function(a){var b=this.player.side==e.PLAYER_SIDE_TOP,c=this.player.board,a=a||this.position,d=Math.floor((a.y-c.y)/g.board.rowHeight);if(b)var d=Math.floor((c.height-a.y)/g.board.rowHeight);var f=d%2==0?g.bubble.radius:2*g.bubble.radius,h=(a.x-c.x+f)/g.bubble.size;return h=Math.round(h),h>g.maxCols&&(h=g.maxCols),d%2==1&&(h-=2),d%2==0&&(h-=1),{row:d,col:h}},d.prototype.fixGridByPosition=function(a){var b=this.getGridByPosition(a);this.row=b.row,this.col=b.col,e.debug&&console.log("fixGridByPosition",this.player.id,a,b)},d.prototype.getPositionByGrid=function(a){var a=a||{row:this.row,col:this.col};if(void 0===a.row||void 0===a.col)return console.error("getPositionByGrid",a.row,a.col),!1;var b=this.player.side==e.PLAYER_SIDE_TOP,c=this.player.board.x,d=this.player.board.y;return c+=a.row%2==0?g.bubble.radius:2*g.bubble.radius,b?(d+=this.player.board.height,d-=a.row*g.board.rowHeight,d-=g.bubble.radius):(d+=a.row*g.board.rowHeight,d+=g.bubble.radius),{x:c+a.col*g.bubble.size,y:d}},d.prototype.fixPositionByGrid=function(a){var b=this.getPositionByGrid(a);this.position.setTo(b.x,b.y),this.createDebugText()},d.prototype.move=function(a,b,c){if(!1===Array.isArray(a))return console.error("invalid parameters, expected Array of steps");this.state=e.BUBBLE_STATE_FIRING;var c=void 0==c?!0:c,d=e.game.add.tween(this);if(a.forEach(function(a){d.to({x:a.position.x,y:a.position.y},a.duration)}),c){var f=a.pop().position;this.fixGridByPosition(f),this.player.board.addBubble(this),this._endPosition=this.getPositionByGrid()}d.onComplete.add(function(){c&&(this.state=e.BUBBLE_STATE_ON_BOARD,this.fixPositionByGrid(),delete this._endPosition),b&&b(this)}.bind(this)),d.start()},d.prototype.getMetaData=function(){return{tag:this.tag,radius:this.radius,row:this.row,col:this.col,x:this.x,y:this.y,position:{x:this.x,y:this.y},_endPosition:this._endPosition,state:this.state}},d.prototype.createDebugText=function(){if(!e.debug)return!1;if(!this.debugText){var a={font:"20px Arial",fill:"#000"},b=e.game.add.text(0,0,"",a);b.anchor.setTo(.5),this.addChild(b),this.debugText=b}return void 0==this.row||void 0==this.col?this.debugText.setText(""):void this.debugText.setText(String(this.row)+" - "+String(this.col))},d.create=function(a,b,c,f){var h=e.entities.bubbles.getFirstDead(),f=f||d.getRandomSprite();return h&&(h.revive(),h.row=b,h.col=c,h.frameName=f,h.tag=f,h.scale.setTo(g.bubble.scale),h.player=a,h.visible=!0),h||(h=new d(a,b,c,f)),h.createDebugText(),h},d.TAGS=["green","blue","yellow","red","magenta","orange"],d.getRandomSprite=function(){return d.TAGS[f.getRandomInt(0,d.TAGS.length-1)]},b.exports=d},{"./bubble-shooter.js":6,"./ui.js":17,"./utils.js":18}],8:[function(a,b,c){var d=a("./bubble-shooter.js"),e=a("./ui.js"),f={config:{bubbleRadius:e.bubble.radius,trajectory:{distance:e.bubble.radius/5,speed:1e3}},circleCollision:function(a,b,c){var d=this.circleCollisionDistance(a.position,b.position),e=a.radius+b.radius;return c&&(e-=a.radius*c+b.radius*c),e>d},circleCollisionDistance:function(a,b){var c=a.x-b.x,d=a.y-b.y;return Math.sqrt(c*c+d*d)},bubbleIntersection:function(a,b){for(var c=0;c<b.length;c++){var e=b[c];if(e)for(var g=0;g<e.length;g++){var h=e[g];if(h){var i=h.position;h.state==d.BUBBLE_STATE_FIRING&&(i=h._endPosition);var j=f.circleCollision({position:a.position,radius:a.radius},{position:i,radius:h.radius},.1);if(j)return h}}}return!1}};!function(a){function b(a,c,e,g,h){var i=2e3,j=f.config.bubbleRadius,k=g.side==d.PLAYER_SIDE_TOP,l=g.x+g.width-j,m=g.x+j,n=g.y+j;k&&(n=g.y+g.height-j);var h=h?++h:1,o=!1,p=!1;if(a.x+=c,a.y-=e,!k&&a.y<=n&&(a.y=n,o="top"),k&&a.y>=n&&(a.y=n,o="top"),a.x<=m&&(a.x=m,o="left"),a.x>=l&&(a.x=l,o="right"),h>i)return console.error("Collision.Trajectory.step atingiu limit de iteracoes"),a;if(p=f.bubbleIntersection({position:a,radius:f.config.bubbleRadius},g.grid),o||p){var q=h*f.config.trajectory.distance,r=f.config.trajectory.speed,s=1e3,t=Math.round(q/r*s);return{position:{x:a.x,y:a.y},duration:t,collision:{dist:q,worldBounds:o,bubble:p}}}return b(a,c,e,g,h)}function c(a,c,d){for(var e=[],g={x:a.x,y:a.y},h=2e3,i=Math.sin(c)*f.config.trajectory.distance,j=Math.cos(c)*f.config.trajectory.distance,e=[],k=0;;){k++;var l=b(g,i,j,d);if(l.collision.worldBounds&&(i*=-1),l.angle=c,e.push(l),k>h){console.error("while limit");break}if(!l||l.collision.bubble||"top"==l.collision.worldBounds)break}return e}a.trajectory=c}(f),b.exports=f},{"./bubble-shooter.js":6,"./ui.js":17}],9:[function(a,b,c){function d(a){return setTimeout(a,16.666)}function e(){var a=g.enemy;if(a.shooter._loading)return d(e);var b=n.shift();return b?(a.shooter.bubble||console.error("1]_processEnemyQueue",b.tag),a.shooter.bubble.tag!=b.tag&&(console.error("2]_processEnemyQueue",a.shooter.bubble.tag,b.tag),console.error("2.1]_processEnemyQueue",n.length,n),a.shooter.bubble.tag=b.tag,a.shooter.bubble.frameName=b.tag),console.log("enemy fire",a.shooter.bubble.tag),a.shooter.angle=180-b.angle,a.fire(),a.shooter.reload(),!0):!1}var f,g=a("./bubble-shooter.js"),h=a("./utils.js"),i=a("./ui.js"),j=a("./ai.js"),k=a("./bubble.js"),l=a("./player.js"),m=function(a){this.game=a},n=[];g.nextTick=d,m.prototype={create:function(){g.CurrenteState=this,g.state="stated",g.finishedByServer=!1;var a=this.game.add.image(0,0,"sprites","board_bg");a.width=this.game.width,a.height=this.game.height,this.game.stage.disableVisibilityChange=!0,this.game.forceSingleUpdate=!0,this.game.time.advancedTiming=!0,f=this.game.add.text(0,5,"00",{font:"16px Arial",fill:"#000"}),f.x=5,this.latency=0,g.entities=g.game.add.group();var b=g.game.add.group();g.entities.add(b),g.entities.bubbles=b,g.separator=g.entities.create(0,g.game.world.centerY,h.createRect(i.board.width,i.board.separatorHeight,"#333")),g.separator.anchor.setTo(0,.5),g.game.width>g.separator.width&&(g.separator.x=(g.game.width-g.separator.width)/2),this.createPlayers(this.attachEvents),g.entities.bringToTop(g.entities.bubbles)},createPlayers:function(a){if(g.mode==g.MODES.SINGLEPLAYER){g.player=new l("You",g.PLAYER_SIDE_BOTTOM),g.enemy=new l("Computer",g.PLAYER_SIDE_TOP);var b=Math.round(i.maxRows/3)+1,c=i.maxCols;if(g.debug){var d=g.player.board.createGrid(b,c).slice(0);g.player.board.setGrid(d.slice(0)),g.enemy.board.setGrid(d.slice(0))}else g.player.board.setGrid(g.player.board.createGrid(b,c)),g.enemy.board.setGrid(g.enemy.board.createGrid(b,c));g.player.board.create(),g.enemy.board.create(),0==g.debug&&(g.player.shooter.load(k.getRandomSprite()),g.enemy.shooter.load(k.getRandomSprite()));var f=g.debug?k.getRandomSprite():null;return g.player.shooter.reload(!0,f),g.enemy.shooter.reload(!0,f),0==g.debug&&(g.computer=new j(g.enemy)),g.player.enemy=g.enemy,g.enemy.enemy=g.player,a.call(this)}if(g.mode==g.MODES.MULTIPLAYER){var h=this;g.server.removeAllListeners(),g.server.on("player-fire",function(a,b){console.log("player-fire",a),g.enemy.shooter.load(a.load),n.push(a),e(),b()}),g.server.on("player-reload",function(a,b){console.log("player-reload",a),g.player.shooter.load(a),g.player.shooter.reload(),b()}),g.server.on("finish",function(a){g.finishedByServer=!0,console.log("finish: ",a),a==g.player.id?h.finish(g.player):h.finish(g.enemy)});var m=g.room,o=m.players[0],p=m.players[1];return g.nickname==p.id?(g.player=new l(p.id,g.PLAYER_SIDE_BOTTOM),g.enemy=new l(o.id,g.PLAYER_SIDE_TOP),g.player.board.setGrid(p.grid),g.enemy.board.setGrid(o.grid),g.player.shooter.load(p.bubbles),g.enemy.shooter.load(o.bubbles)):(g.player=new l(o.id,g.PLAYER_SIDE_BOTTOM),g.enemy=new l(p.id,g.PLAYER_SIDE_TOP),g.player.board.setGrid(o.grid),g.enemy.board.setGrid(p.grid),g.player.shooter.load(o.bubbles),g.enemy.shooter.load(p.bubbles)),g.player.board.create(),g.enemy.board.create(),g.player.shooter.reload(!0),g.enemy.shooter.reload(!0),g.player.enemy=g.enemy,g.enemy.enemy=g.player,a.call(this)}},attachEvents:function(){this.game.input.addMoveCallback(this.inputMove,this),this.game.input.onUp.add(this.inputUp,this),this.game.canvas.style.cursor="crosshair"},detachEvents:function(){this.game.input.deleteMoveCallback(this.inputMove,this),this.game.input.onUp.remove(this.inputUp,this),this.game.canvas.style.cursor="default"},update:function(){f.setText(this.time.fps+" | "+this.latency)},render:function(){},inputUp:function(a,b){if(this.isMultiplayer()){if(!g.player.shooter._loaded)return!1;var c={playerId:g.player.id,angle:g.player.shooter.angle,tag:g.player.shooter.bubble.tag};g.server.emit("player-fire",c)}else{var d=k.getRandomSprite();g.player.shooter.load(d),g.debug&&(g.enemy.shooter.load(d),g.enemy.fire(),g.enemy.shooter.reload())}g.player.fire(),g.player.shooter.reload()},inputMove:function(a,b,c,d){var e=this.game.math.angleBetween(g.player.shooter.x,g.player.shooter.y,b,c);e+=1.57079633,g.player.shooter.setRotation(e),g.debug&&(g.enemy.shooter.angle=180-g.player.shooter.angle)},finish:function(a){if("finished"==g.state)return!1;g.state="finished";g.player==a?g.enemy:g.player;if(console.log("game has finished",a.id),this.isMultiplayer()){if(!g.finishedByServer){var b=g.room,c={winnerID:a.id,room:{id:b.id,players:[{id:b.players[0].id},{id:b.players[1].id}],state:b.state}};console.log("BubbleShooter.server.emit(finish)",c),g.server.emit("finish",c)}}else 0==g.debug&&g.computer.stop();this.detachEvents(),this.createModalLayer();var d=g.player==a,e=d?"win_finger":"lose_finger",f=d?"you_won":"you_lose",h=this.game.add.sprite(this.game.world.centerX,this.game.world.centerY,"sprites",e);h.anchor.setTo(.5),h.y+=80;var i=this.game.add.sprite(this.game.world.centerX,this.game.world.centerY,"sprites",f);i.anchor.setTo(.5),i.y-=120;var j=this.game.add.bitmapText(this.game.world.centerX,0,"dunkin","Menu",30);return j.alpha=0,j.scale.setTo(0),j.anchor.setTo(.5),j.inputEnabled=!0,j.events.onInputDown.add(function(){this.state.start("menu")},this),this.game.add.tween(j).to({alpha:1,y:60},500,Phaser.Easing.Back.Out,!0,500),void this.game.add.tween(j.scale).to({x:1,y:1},500,Phaser.Easing.Back.Out,!0,700)},isMultiplayer:function(){return g.mode==g.MODES.MULTIPLAYER},createModalLayer:function(){var a=h.createRect(g.game.width,g.game.height,"rgba(25, 25, 25, 0.9)"),b=g.entities.create(0,0,a);return b.bringToTop(),b}},b.exports=m},{"./ai.js":1,"./bubble-shooter.js":6,"./bubble.js":7,"./player.js":11,"./ui.js":17,"./utils.js":18}],10:[function(a,b,c){var d=a("./bubble-shooter.js"),e=(a("./utils.js"),a("./ui.js"),function(a){this.game=a});e.prototype={create:function(){var a=this.game.add.image(0,0,"sprites","menu_bg");a.width=this.game.width,a.height=this.game.height;var b=this.game.add.bitmapText(0,this.game.height,"dunkin","Play",50);b.tint=16089631,b.x=20,b.y=this.game.height-b.height-30,b.inputEnabled=!0,b.events.onInputDown.add(function(){this.getNickName(),d.mode=d.MODES.MULTIPLAYER,this.state.start("room")},this);var c=this.game.add.bitmapText(0,this.game.height,"dunkin","Practice",30);c.tint=16089631,c.x=this.game.width-c.width-20,c.y=this.game.height-c.height-33,c.inputEnabled=!0,c.events.onInputDown.add(function(){d.mode=d.MODES.SINGLEPLAYER,this.state.start("game")},this);var e=[{id:"joao",wins:120},{id:"player-2323",wins:80},{id:"duke",wins:59},{id:"kael",wins:23},{id:"shooter",wins:13},{id:"player-64564",wins:10},{id:"player-54657",wins:10},{id:"player-54657",wins:7},{id:"player-54657",wins:3},{id:"player-54657",wins:1}],f=60,g=this.game.world.centerY-80,h=this.game.add.bitmapText(f,g,"dunkin","Hall of Fame",28);h.tint=14750595,g+=40;var i=this.game.add.bitmapText(f,g,"dunkin","Nick",18);i.tint=14750595;var j=f+200,k=this.game.add.bitmapText(j,g,"dunkin","Wins",18);k.tint=14750595,g+=30;for(var l=0,m=e.length;m>l;l++){var n=e[l],i=this.game.add.bitmapText(f,g,"dunkin",l+1+" - "+n.id,16);i.tint=14750595;var o=this.game.add.bitmapText(j,g,"dunkin",String(n.wins),16);o.tint=14750595,g+=20}return},getNickName:function(){var a;localStorage.getItem("bubble_shooter_nickname")?a=localStorage.getItem("bubble_shooter_nickname"):(a="player-"+Math.round(99999*Math.random())+1,localStorage.setItem("bubble_shooter_nickname",a)),d.nickname=a},startFullScreen:function(){this.game.scale.fullScreenScaleMode=Phaser.ScaleManager.SHOW_ALL,this.game.scale.startFullScreen(!1)}},b.exports=e},{"./bubble-shooter.js":6,"./ui.js":17,"./utils.js":18}],11:[function(a,b,c){function d(a,b){this.id=a,this.side=b,this.shooter=new f(this),this.board=new g(this)}var e=a("./bubble-shooter.js"),f=a("./shooter.js"),g=a("./board.js");d.prototype={getMetaData:function(){return{id:this.id,side:this.side,shooter:this.shooter.getMetaData(),board:this.board.getMetaData()}},fire:function(a,b){var c=function(b){var c=!1,d=!1;if((this.side==e.PLAYER_SIDE_BOTTOM&&b.y+b.radius>this.shooter.y-this.shooter.height/2||this.side==e.PLAYER_SIDE_TOP&&b.y-b.radius<this.shooter.y+this.shooter.height/2)&&(d=!0),!d){this.board.checkMatches(b),this.board.checkOrphans();var f=this.board.getRemaining();0==f.length&&(c=!0)}c&&e.CurrenteState.finish(this),d&&e.CurrenteState.finish(this.enemy),a&&a()};this.shooter.fire(c.bind(this),b)}},b.exports=d},{"./board.js":3,"./bubble-shooter.js":6,"./shooter.js":16}],12:[function(a,b,c){var d=function(a){this.game=a};d.prototype={preload:function(){this.game.add.image(0,0,"loading-bg");bck=this.add.sprite(this.world.centerX,this.world.centerY,"preload-background"),bck.anchor.setTo(.5,.5),bck.scale.setTo(.5,.5),preloadBar=this.add.sprite(this.world.centerX,this.world.centerY,"preload-bar"),preloadBar.anchor.setTo(0,.5),preloadBar.scale.setTo(.5,1),preloadBar.x=this.world.centerX-preloadBar.width/2,this.load.setPreloadSprite(preloadBar),document.getElementById("loader").style.display="none",this.load.atlasJSONHash("sprites","src/img/sprites.png","src/json/sprites.json"),this.load.atlasJSONHash("hand","src/img/hand.png","src/json/hand.json"),this.load.bitmapFont("font","src/img/font.png","src/xml/font.xml"),this.load.bitmapFont("dunkin","src/img/dunkin.png","src/xml/dunkin.fnt"),this.load.image("arrow","src/img/arrow.png")},create:function(){this.state.start("menu")}},b.exports=d},{}],13:[function(a,b,c){var d=a("./bubble-shooter.js"),e=a("./utils.js"),f=function(a){this.entities=[],this.game=a};f.prototype={create:function(){this.game.stage.disableVisibilityChange=!0,delete this.room,d.server.removeAllListeners(),this.createButton("back",{position:{x:66,y:35},callback:this.back,context:this});var a=(d.game.add.sprite(10,110,e.createRect(566,900,"#333")),{player:{id:d.nickname}});return this.text=this.createLabel("Connecting to server...",{position:{x:10,y:70}}),d.joinRoom?(a.room=d.joinRoom.id,d.server.emit("join-room",a,function(a,b){return a?(console.error(a),this.back()):void this.updateList(b)}.bind(this)),d.server.once("host-close-room",function(a){this.room=!1,this.back()},this),void d.server.once("play",function(a){d.room=a,this.state.start("game")},this)):(d.server.once("player-join-room",function(a){this.updateList(a)},this),d.server.once("player-leave-room",function(a){this.updateList(a)},this),void d.server.emit("create-room",a,function(a,b){this.updateList(b)}.bind(this)))},updateList:function(a){this.clearEntities(),this.room=a,this.text.setText(a.name);for(var b={position:{x:20,y:120}},c=0,e=a.players.length;e>c;c++)this.createItem("#"+(c+1)+" - "+a.players[c].id,b),b.position.y+=55;if(d.nickname==a.host.id){var f=this.createButton("Play",{position:{x:525,y:35},callback:this.play,context:this});this.entities.push(f)}},play:function(){var a=this.room,b=this;return a?a.players.length<2?alert("room is not full"):void d.server.emit("play",a,function(a,c){console.log("play",c),d.room=c,b.state.start("game")}):alert("Error: room not found")},createItem:function(a,b){var c=545,f=48,g=d.game.add.sprite(b.position.x,b.position.y,e.createRect(c,f,"#222")),a=this.createLabel(a,{position:{x:b.position.x+10,y:b.position.y+5}}),h=this.createButton("ready",{position:{x:b.position.x+493,y:b.position.y+24},fontSize:20,background:"#333"});this.entities.push(g),this.entities.push(a),this.entities.push(h)},clearEntities:function(){for(var a=0,b=this.entities.length;b>a;a++)this.entities[a]&&this.entities[a].destroy();this.entities=[]},createLabel:function(a,b){var c=this.game.add.bitmapText(b.position.x,b.position.y,"font",a,20);return c},createButton:function(a,b){return b.label=a,e.createButton(b)},back:function(){var a=function(){this.state.start("room")};if(!this.room)return a.call(this);var b={player:{id:d.nickname},room:this.room.id};return d.server.emit("leave-room",b,a.bind(this))}},b.exports=f},{"./bubble-shooter.js":6,"./utils.js":18}],14:[function(a,b,c){var d=a("./bubble-shooter.js"),e=a("./utils.js"),f=a("./server.js"),g=function(a){this.game=a};g.prototype={create:function(){d.joinRoom=!1,d.server||(d.server=new f,console.log("create server"));var a=this,b=(this.createButton("back",{position:{x:66,y:35},callback:this.back,context:this}),this.statusText=this.game.add.bitmapText(this.game.world.centerX,this.game.world.centerY,"font","Connecting...",18));b.anchor.setTo(.5),d.server.connect(function(c){return c?(console.error(c),b.setText(c)):(a.getTotalPlayersOnline(),void a.findOpponent())})},findOpponent:function(){this.statusText.setText("find opponent...")},getTotalPlayersOnline:function(){this.game.add.bitmapText(10,70,"font","Players online: 26",20)},createLabel:function(a,b){var c=this.game.add.bitmapText(b.position.x,b.position.y,"font",a,20);return c},createButton:function(a,b){return b.label=a,e.createButton(b)},createListRooms:function(){var a=566,b=900,c=(d.game.add.sprite(10,110,e.createRect(a,b,"#333")),this.createLabel("loading...",{position:{x:20,y:120}})),f=function(a,b){if(c.destroy(),b.reverse(),0==b.length)return this.createLabel("no room was created",{position:{x:20,y:120}});for(var f={x:20,y:120},g=0,h=b.length;h>g;g++){var i=b[g],j=i.players.length+"/2",k=i.players.length<2;d.game.add.sprite(f.x,f.y,e.createRect(545,48,"#222"));this.createLabel(i.name,{position:{x:f.x+10,y:f.y+5}}),this.createLabel(j,{position:{x:f.x+240,y:f.y+5}});if(k){var l=this.createButton("join",{position:{x:f.x+504,y:f.y+25},fontSize:20,context:this,callback:function(a){return function(){this.join(a)}}(i)});l.room=i}else this.createLabel("Full",{position:{x:f.x+480,y:f.y+7}});f.y+=60}};d.server.getRooms(f.bind(this))},join:function(a){d.joinRoom=a,this.state.start("room-create")},back:function(){d.server.connected()&&d.server.disconnect(),this.state.start("menu")},createRoom:function(){this.state.start("room-create")}},b.exports=g},{"./bubble-shooter.js":6,"./server.js":15,"./utils.js":18}],15:[function(a,b,c){function d(){this.socket=null,this.events={},this.host="127.0.0.1",this.port=8080,this.path="http://"+this.host+":"+this.port,this.updateOnConnect=!1,this.userDisconnect=!1}var e=a("./bubble-shooter.js");d.prototype.send=function(a){return this.socket.send(a)},d.prototype.emit=function(a,b,c){return this.socket?this.socket.emit(a,b,c):setTimeout(function(){return this.emit(a,b,c)}.bind(this),100)},d.prototype.on=function(a,b,c){this.events[a]=c?b.bind(c):b,this.socket.on(a,this.events[a])},d.prototype.once=function(a,b,c){this.removeListener(a),this.on(a,b,c)},d.prototype.removeListener=function(a){this.events[a]&&this.socket.removeListener(a,this.events[a])},d.prototype.removeAllListeners=function(){return this.socket.removeAllListeners()},d.prototype.connected=function(){return this.socket&&this.socket.connected},d.prototype.connect=function(a){var b="no connection with server\ntry again later";if(this.socket||(this.socket=io(this.path,{port:this.port,secure:!1})),this.connected()||(this.socket=this.socket.connect()),!this.socket)return a(b);this.removeAllListeners(),this.registryDefaultEvents();var c=0;this.socket.on("connect_error",function(){console.log("socket.on connect_error",c+1),++c>6&&(console.log("connect_error abort"),c=0,this.disconnect(),a(b))}.bind(this)),this.socket.on("connect",a)},d.prototype.registryDefaultEvents=function(){var a=this;this.socket.on("connect",function(){a.userDisconnect=!1,console.log("connect",a.updateOnConnect);var b={playerID:e.nickname,reconnect:a.updateOnConnect};a.socket.emit("join",b,function(a){a&&console.error("join error",a)})}),this.socket.on("disconnect",function(){a.updateOnConnect=!a.userDisconnect,console.log("disconnect",a.updateOnConnect)}),this.socket.on("error",function(){console.error("socket.on error:",arguments)})},d.prototype.ping=function(a){console.log("ping");var b=Date.now();this.socket.emit("ping",function(){console.log("pong"),a(Date.now()-b)})},d.prototype.disconnect=function(){this.userDisconnect=!0,this.socket.disconnect()},d.prototype.requireSocketLibray=function(a){if(window.io)return a();var b=document.getElementsByTagName("head")[0],c=document.createElement("script");c.addEventListener("load",function(){a(!1)}),c.addEventListener("error",function(){console.error("erro ao carregar script"),a("Error")}),c.src=this.path+"/socket.io/socket.io.js",c.async=!0,b.appendChild(c)},b.exports=d},{"./bubble-shooter.js":6}],16:[function(a,b,c){var d=a("./bubble-shooter.js"),e=a("./ui.js"),f=a("./bubble.js"),g=a("./utils.js"),h=a("./collision.js"),i=function(a){Phaser.Sprite.call(this,d.game,d.game.world.centerX,0,"arrow"),d.entities.add(this),a.shooter=this,this.player=a,this._loaded=!1,this._loading=!1,this._queue=[],this.anchor.setTo(.5,.9),this.y=this.height,a.side==d.PLAYER_SIDE_TOP&&(this.rotation=g.degreesToRadians(180)),a.side==d.PLAYER_SIDE_BOTTOM&&(this.angle=0),this.createHand(),this.createHandAnimations()};i.prototype=Object.create(Phaser.Sprite.prototype),i.prototype.constructor=i,i.prototype.fire=function(a,b){var c=this.bubble;if(!c||!this._loaded)return!1;c.visible=!0,this.hand.angle=this.angle,this.hand.play(c.tag,20);var e=20,f=Math.sin(this.rotation)*e,g=Math.cos(this.rotation)*e;if(this.player.side===d.PLAYER_SIDE_TOP);else{console.log("fire",f,g);var i=d.game.add.tween(this.hand);i.to({x:this.hand.x+f,y:this.hand.y-g},200),i.to({x:this.hand.x,y:this.hand.y},200),i.to({rotation:0},10),i.start()}this.bubble=null;var b=b||h.trajectory(this.position,this.rotation,this.player.board);return c.rotation=this.rotation,c.move(b,a),!0},i.prototype.getBitmapData=function(){if(!this.bmd){this.bmd=d.game.add.bitmapData(this.player.board.width,this.player.board.height);var a=d.game.add.sprite(this.player.board.x,this.player.board.y,this.bmd);d.entities.add(a)}return this.bmd},i.prototype.showTrajectory=function(){return!1},i.prototype.load=function(a){return Array.isArray(a)?this._queue=this._queue.concat(a):void this._queue.push(a)},i.prototype.getNextTag=function(){return this._queue.shift()},i.prototype.reload=function(a,b){if(this.bubble||this._loading)return!1;this._loading=!0,this._loaded=!1;var b=b||this.getNextTag();if(!b)return!1;var c=f.create(this.player,null,null,b);c.anchor.setTo(.5),c.position.set(this.x,this.y),c.visible=!1,this.hand.frameName="hand1_"+c.tag,this.hand.visible=!0;var e=function(){this.bubble=c,this._loading=!1,this._loaded=!0};return d.nextTick(e.bind(this))},i.prototype.setRotation=function(a){this.rotation=a,this.player.side==d.PLAYER_SIDE_BOTTOM&&Math.abs(this.angle)>85&&(this.angle=this.angle>0?85:-85),this.player.side==d.PLAYER_SIDE_TOP&&Math.abs(this.angle)<95&&(this.angle=this.angle>0?95:-95)},i.prototype.createHand=function(){this.hand=d.game.add.sprite(this.x,this.y,"hand","hand1_green"),d.entities.add(this.hand),this.hand.anchor.setTo(.44,.44),this.hand.scale.setTo(e.bubble.scale),this.hand.angle=this.angle,this.hand.visible=!1},i.prototype.createHandAnimations=function(){function a(){this.bubble&&(this.hand.frameName="hand1_"+this.bubble.frameName)}for(var b=0,c=f.TAGS.length;c>b;b++){var d=f.TAGS[b],e=this.hand.animations.add(d,["hand1_"+d,"hand2_"+d,"hand3_"+d,"hand4_"+d]);e.onComplete.add(a.bind(this));
}},i.prototype.getMetaData=function(){return{x:this.x,y:this.y,position:{x:this.x,y:this.y},rotation:this.rotation}},b.exports=i},{"./bubble-shooter.js":6,"./bubble.js":7,"./collision.js":8,"./ui.js":17,"./utils.js":18}],17:[function(a,b,c){var d=26.5,e=2*d,f=6,g=8,h=e,i=360,j=640,k=i,l=j,m=i-48,n=j/2,o=m/h/g,p=e*o,q={background:"#F5821F",width:k,height:l,maxRows:f,maxCols:g,bubble:{scale:o,size:p,radius:p/2},board:{width:m,height:n,rowHeight:p-9,separatorHeight:5}};b.exports=q},{}],18:[function(a,b,c){function d(){return Math.random().toString(36).substring(2,15)+Math.random().toString(36).substring(2,15)}function e(a,b){return Math.floor(Math.random()*(b-a+1))+a}function f(a){return a*Math.PI/180}function g(a){return 180*a/Math.PI}function h(a,b,c){var d=j.game.add.bitmapData(a,b);return d.ctx.beginPath(),d.ctx.rect(0,0,a,b),d.ctx.fillStyle=c,d.ctx.fill(),d.ctx.closePath(),d}function i(a){var b="#444",c=j.game.add.bitmapText(0,0,"dunkin",a.label,a.fontSize||30);c.anchor.setTo(.5),c.alpha=a.alpha||.7;var d=j.game.add.sprite(a.position.x,a.position.y,h(c.width+25,c.height+18,a.background||b));return d.anchor.setTo(.5),d.addChild(c),a.callback&&(d.inputEnabled=!0,d.events.onInputDown.add(a.callback,a.context)),d}var j=a("./bubble-shooter.js"),k=function(){function a(a,b){return a+b}return function(b){return b.reduce(a,0)/b.length}}(),l=function(){var a=function(a){var b=0,c=0;for(c in a)a.hasOwnProperty(c)&&b++;return b},b=function(a,b){var c=0,d=0;for(d in a)if(a.hasOwnProperty(d)){if(c==b)return d;c++}return!1},c=function(a,b,c){return c=null!==c?c:1,a=d(a)?1*a:a.toLowerCase(),b=d(b)?1*b:b.toLowerCase(),a==b?0:a>b?1*c:-1*c},d=function(a){return!isNaN(parseFloat(a))&&isFinite(a)};return function(d,e){e=e||{};var f=a(e);if(!f)return d.sort(c);for(var g in e)e[g]="desc"==e[g]||-1==e[g]?-1:"skip"==e[g]||0===e[g]?0:1;return d.sort(function(a,d){for(var g=0,h=0;0===g&&f>h;){var i=b(e,h);if(i){var j=e[i];g=c(a[i],d[i],j),h++}}return g}),d}}(),m=function(){var a=[{base:"A",letters:/[\u0041\u24B6\uFF21\u00C0\u00C1\u00C2\u1EA6\u1EA4\u1EAA\u1EA8\u00C3\u0100\u0102\u1EB0\u1EAE\u1EB4\u1EB2\u0226\u01E0\u00C4\u01DE\u1EA2\u00C5\u01FA\u01CD\u0200\u0202\u1EA0\u1EAC\u1EB6\u1E00\u0104\u023A\u2C6F]/g},{base:"AA",letters:/[\uA732]/g},{base:"AE",letters:/[\u00C6\u01FC\u01E2]/g},{base:"AO",letters:/[\uA734]/g},{base:"AU",letters:/[\uA736]/g},{base:"AV",letters:/[\uA738\uA73A]/g},{base:"AY",letters:/[\uA73C]/g},{base:"B",letters:/[\u0042\u24B7\uFF22\u1E02\u1E04\u1E06\u0243\u0182\u0181]/g},{base:"C",letters:/[\u0043\u24B8\uFF23\u0106\u0108\u010A\u010C\u00C7\u1E08\u0187\u023B\uA73E]/g},{base:"D",letters:/[\u0044\u24B9\uFF24\u1E0A\u010E\u1E0C\u1E10\u1E12\u1E0E\u0110\u018B\u018A\u0189\uA779]/g},{base:"DZ",letters:/[\u01F1\u01C4]/g},{base:"Dz",letters:/[\u01F2\u01C5]/g},{base:"E",letters:/[\u0045\u24BA\uFF25\u00C8\u00C9\u00CA\u1EC0\u1EBE\u1EC4\u1EC2\u1EBC\u0112\u1E14\u1E16\u0114\u0116\u00CB\u1EBA\u011A\u0204\u0206\u1EB8\u1EC6\u0228\u1E1C\u0118\u1E18\u1E1A\u0190\u018E]/g},{base:"F",letters:/[\u0046\u24BB\uFF26\u1E1E\u0191\uA77B]/g},{base:"G",letters:/[\u0047\u24BC\uFF27\u01F4\u011C\u1E20\u011E\u0120\u01E6\u0122\u01E4\u0193\uA7A0\uA77D\uA77E]/g},{base:"H",letters:/[\u0048\u24BD\uFF28\u0124\u1E22\u1E26\u021E\u1E24\u1E28\u1E2A\u0126\u2C67\u2C75\uA78D]/g},{base:"I",letters:/[\u0049\u24BE\uFF29\u00CC\u00CD\u00CE\u0128\u012A\u012C\u0130\u00CF\u1E2E\u1EC8\u01CF\u0208\u020A\u1ECA\u012E\u1E2C\u0197]/g},{base:"J",letters:/[\u004A\u24BF\uFF2A\u0134\u0248]/g},{base:"K",letters:/[\u004B\u24C0\uFF2B\u1E30\u01E8\u1E32\u0136\u1E34\u0198\u2C69\uA740\uA742\uA744\uA7A2]/g},{base:"L",letters:/[\u004C\u24C1\uFF2C\u013F\u0139\u013D\u1E36\u1E38\u013B\u1E3C\u1E3A\u0141\u023D\u2C62\u2C60\uA748\uA746\uA780]/g},{base:"LJ",letters:/[\u01C7]/g},{base:"Lj",letters:/[\u01C8]/g},{base:"M",letters:/[\u004D\u24C2\uFF2D\u1E3E\u1E40\u1E42\u2C6E\u019C]/g},{base:"N",letters:/[\u004E\u24C3\uFF2E\u01F8\u0143\u00D1\u1E44\u0147\u1E46\u0145\u1E4A\u1E48\u0220\u019D\uA790\uA7A4]/g},{base:"NJ",letters:/[\u01CA]/g},{base:"Nj",letters:/[\u01CB]/g},{base:"O",letters:/[\u004F\u24C4\uFF2F\u00D2\u00D3\u00D4\u1ED2\u1ED0\u1ED6\u1ED4\u00D5\u1E4C\u022C\u1E4E\u014C\u1E50\u1E52\u014E\u022E\u0230\u00D6\u022A\u1ECE\u0150\u01D1\u020C\u020E\u01A0\u1EDC\u1EDA\u1EE0\u1EDE\u1EE2\u1ECC\u1ED8\u01EA\u01EC\u00D8\u01FE\u0186\u019F\uA74A\uA74C]/g},{base:"OI",letters:/[\u01A2]/g},{base:"OO",letters:/[\uA74E]/g},{base:"OU",letters:/[\u0222]/g},{base:"P",letters:/[\u0050\u24C5\uFF30\u1E54\u1E56\u01A4\u2C63\uA750\uA752\uA754]/g},{base:"Q",letters:/[\u0051\u24C6\uFF31\uA756\uA758\u024A]/g},{base:"R",letters:/[\u0052\u24C7\uFF32\u0154\u1E58\u0158\u0210\u0212\u1E5A\u1E5C\u0156\u1E5E\u024C\u2C64\uA75A\uA7A6\uA782]/g},{base:"S",letters:/[\u0053\u24C8\uFF33\u1E9E\u015A\u1E64\u015C\u1E60\u0160\u1E66\u1E62\u1E68\u0218\u015E\u2C7E\uA7A8\uA784]/g},{base:"T",letters:/[\u0054\u24C9\uFF34\u1E6A\u0164\u1E6C\u021A\u0162\u1E70\u1E6E\u0166\u01AC\u01AE\u023E\uA786]/g},{base:"TZ",letters:/[\uA728]/g},{base:"U",letters:/[\u0055\u24CA\uFF35\u00D9\u00DA\u00DB\u0168\u1E78\u016A\u1E7A\u016C\u00DC\u01DB\u01D7\u01D5\u01D9\u1EE6\u016E\u0170\u01D3\u0214\u0216\u01AF\u1EEA\u1EE8\u1EEE\u1EEC\u1EF0\u1EE4\u1E72\u0172\u1E76\u1E74\u0244]/g},{base:"V",letters:/[\u0056\u24CB\uFF36\u1E7C\u1E7E\u01B2\uA75E\u0245]/g},{base:"VY",letters:/[\uA760]/g},{base:"W",letters:/[\u0057\u24CC\uFF37\u1E80\u1E82\u0174\u1E86\u1E84\u1E88\u2C72]/g},{base:"X",letters:/[\u0058\u24CD\uFF38\u1E8A\u1E8C]/g},{base:"Y",letters:/[\u0059\u24CE\uFF39\u1EF2\u00DD\u0176\u1EF8\u0232\u1E8E\u0178\u1EF6\u1EF4\u01B3\u024E\u1EFE]/g},{base:"Z",letters:/[\u005A\u24CF\uFF3A\u0179\u1E90\u017B\u017D\u1E92\u1E94\u01B5\u0224\u2C7F\u2C6B\uA762]/g},{base:"a",letters:/[\u0061\u24D0\uFF41\u1E9A\u00E0\u00E1\u00E2\u1EA7\u1EA5\u1EAB\u1EA9\u00E3\u0101\u0103\u1EB1\u1EAF\u1EB5\u1EB3\u0227\u01E1\u00E4\u01DF\u1EA3\u00E5\u01FB\u01CE\u0201\u0203\u1EA1\u1EAD\u1EB7\u1E01\u0105\u2C65\u0250]/g},{base:"aa",letters:/[\uA733]/g},{base:"ae",letters:/[\u00E6\u01FD\u01E3]/g},{base:"ao",letters:/[\uA735]/g},{base:"au",letters:/[\uA737]/g},{base:"av",letters:/[\uA739\uA73B]/g},{base:"ay",letters:/[\uA73D]/g},{base:"b",letters:/[\u0062\u24D1\uFF42\u1E03\u1E05\u1E07\u0180\u0183\u0253]/g},{base:"c",letters:/[\u0063\u24D2\uFF43\u0107\u0109\u010B\u010D\u00E7\u1E09\u0188\u023C\uA73F\u2184]/g},{base:"d",letters:/[\u0064\u24D3\uFF44\u1E0B\u010F\u1E0D\u1E11\u1E13\u1E0F\u0111\u018C\u0256\u0257\uA77A]/g},{base:"dz",letters:/[\u01F3\u01C6]/g},{base:"e",letters:/[\u0065\u24D4\uFF45\u00E8\u00E9\u00EA\u1EC1\u1EBF\u1EC5\u1EC3\u1EBD\u0113\u1E15\u1E17\u0115\u0117\u00EB\u1EBB\u011B\u0205\u0207\u1EB9\u1EC7\u0229\u1E1D\u0119\u1E19\u1E1B\u0247\u025B\u01DD]/g},{base:"f",letters:/[\u0066\u24D5\uFF46\u1E1F\u0192\uA77C]/g},{base:"g",letters:/[\u0067\u24D6\uFF47\u01F5\u011D\u1E21\u011F\u0121\u01E7\u0123\u01E5\u0260\uA7A1\u1D79\uA77F]/g},{base:"h",letters:/[\u0068\u24D7\uFF48\u0125\u1E23\u1E27\u021F\u1E25\u1E29\u1E2B\u1E96\u0127\u2C68\u2C76\u0265]/g},{base:"hv",letters:/[\u0195]/g},{base:"i",letters:/[\u0069\u24D8\uFF49\u00EC\u00ED\u00EE\u0129\u012B\u012D\u00EF\u1E2F\u1EC9\u01D0\u0209\u020B\u1ECB\u012F\u1E2D\u0268\u0131]/g},{base:"j",letters:/[\u006A\u24D9\uFF4A\u0135\u01F0\u0249]/g},{base:"k",letters:/[\u006B\u24DA\uFF4B\u1E31\u01E9\u1E33\u0137\u1E35\u0199\u2C6A\uA741\uA743\uA745\uA7A3]/g},{base:"l",letters:/[\u006C\u24DB\uFF4C\u0140\u013A\u013E\u1E37\u1E39\u013C\u1E3D\u1E3B\u017F\u0142\u019A\u026B\u2C61\uA749\uA781\uA747]/g},{base:"lj",letters:/[\u01C9]/g},{base:"m",letters:/[\u006D\u24DC\uFF4D\u1E3F\u1E41\u1E43\u0271\u026F]/g},{base:"n",letters:/[\u006E\u24DD\uFF4E\u01F9\u0144\u00F1\u1E45\u0148\u1E47\u0146\u1E4B\u1E49\u019E\u0272\u0149\uA791\uA7A5]/g},{base:"nj",letters:/[\u01CC]/g},{base:"o",letters:/[\u006F\u24DE\uFF4F\u00F2\u00F3\u00F4\u1ED3\u1ED1\u1ED7\u1ED5\u00F5\u1E4D\u022D\u1E4F\u014D\u1E51\u1E53\u014F\u022F\u0231\u00F6\u022B\u1ECF\u0151\u01D2\u020D\u020F\u01A1\u1EDD\u1EDB\u1EE1\u1EDF\u1EE3\u1ECD\u1ED9\u01EB\u01ED\u00F8\u01FF\u0254\uA74B\uA74D\u0275]/g},{base:"oi",letters:/[\u01A3]/g},{base:"ou",letters:/[\u0223]/g},{base:"oo",letters:/[\uA74F]/g},{base:"p",letters:/[\u0070\u24DF\uFF50\u1E55\u1E57\u01A5\u1D7D\uA751\uA753\uA755]/g},{base:"q",letters:/[\u0071\u24E0\uFF51\u024B\uA757\uA759]/g},{base:"r",letters:/[\u0072\u24E1\uFF52\u0155\u1E59\u0159\u0211\u0213\u1E5B\u1E5D\u0157\u1E5F\u024D\u027D\uA75B\uA7A7\uA783]/g},{base:"s",letters:/[\u0073\u24E2\uFF53\u00DF\u015B\u1E65\u015D\u1E61\u0161\u1E67\u1E63\u1E69\u0219\u015F\u023F\uA7A9\uA785\u1E9B]/g},{base:"t",letters:/[\u0074\u24E3\uFF54\u1E6B\u1E97\u0165\u1E6D\u021B\u0163\u1E71\u1E6F\u0167\u01AD\u0288\u2C66\uA787]/g},{base:"tz",letters:/[\uA729]/g},{base:"u",letters:/[\u0075\u24E4\uFF55\u00F9\u00FA\u00FB\u0169\u1E79\u016B\u1E7B\u016D\u00FC\u01DC\u01D8\u01D6\u01DA\u1EE7\u016F\u0171\u01D4\u0215\u0217\u01B0\u1EEB\u1EE9\u1EEF\u1EED\u1EF1\u1EE5\u1E73\u0173\u1E77\u1E75\u0289]/g},{base:"v",letters:/[\u0076\u24E5\uFF56\u1E7D\u1E7F\u028B\uA75F\u028C]/g},{base:"vy",letters:/[\uA761]/g},{base:"w",letters:/[\u0077\u24E6\uFF57\u1E81\u1E83\u0175\u1E87\u1E85\u1E98\u1E89\u2C73]/g},{base:"x",letters:/[\u0078\u24E7\uFF58\u1E8B\u1E8D]/g},{base:"y",letters:/[\u0079\u24E8\uFF59\u1EF3\u00FD\u0177\u1EF9\u0233\u1E8F\u00FF\u1EF7\u1E99\u1EF5\u01B4\u024F\u1EFF]/g},{base:"z",letters:/[\u007A\u24E9\uFF5A\u017A\u1E91\u017C\u017E\u1E93\u1E95\u01B6\u0225\u0240\u2C6C\uA763]/g}];return function(b){for(var c=0;c<a.length;c++)b=b.replace(a[c].letters,a[c].base);return b}}();b.exports={mean:k,createRect:h,createButton:i,getRandomInt:e,generateUUID:d,radiansToDegrees:g,degreesToRadians:f,keySort:l,removeAccents:m}},{"./bubble-shooter.js":6}]},{},[5]);